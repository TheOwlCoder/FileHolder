...
SpriteMorph.prototype.initBlocks = function () {
    SpriteMorph.prototype.blocks = {
        ...
        forward: {
            ...
            type: 'command',
            category: 'motion',
            spec: 'relocate to %n steps in front of where i am currently looking',
            defaults: [10]
        },
        turn: {
            only: SpriteMorph,
            type: 'command',
            category: 'motion',
            spec: 'turn my whole sprite clockwise or %clockwise %n degrees',
            defaults: [15]
        },
        turnLeft: {
            only: SpriteMorph,
            type: 'command',
            category: 'motion',
            spec: 'turn my whole sprite counterclockwise or %counterclockwise %n degrees',
            defaults: [15]
        },
        setHeading: {
            only: SpriteMorph,
            type: 'command',
            category: 'motion',
            spec: 'point my whole sprite in the direction %dir',
            defaults: [90]
        },
        doFaceTowards: {
            only: SpriteMorph,
            type: 'command',
            category: 'motion',
            spec: 'point my whole sprite towards %dst',
        ...
        gotoXY: {
            ...
            type: 'command',
            category: 'motion',
            spec: 'go to %n on the x axis on the canvas and %n on the y axis in the canvas',
            defaults: [0, 0]
        },
        doGotoObject: {
            only: SpriteMorph,
            type: 'command',
            category: 'motion',
            spec: 'go to a %dst on the canvas',
        ...
        doGlide: {
            ...
            type: 'command',
            category: 'motion',
            spec: 'go to but better  %n secs to x: %n y: %n on the canvas',
            defaults: [1, 0, 0]
        },
        changeXPosition: {
            only: SpriteMorph,
            type: 'command',
            category: 'motion',
            spec: 'change the x axis on the canvas by %n',
            defaults: [10]
        },
        setXPosition: {
            only: SpriteMorph,
            type: 'command',
            category: 'motion',
            spec: 'set the x on the canvas to %n',
            defaults: [0]
        },
        changeYPosition: {
            only: SpriteMorph,
            type: 'command',
            category: 'motion',
            spec: 'change the y axis on the canvas by %n',
            defaults: [10]
        },
        setYPosition: {
            only: SpriteMorph,
            type: 'command',
            category: 'motion',
            spec: 'set the y axis on the canvas to %n',
            defaults: [0]
        },
        bounceOffEdge: {
            only: SpriteMorph,
        ...
        doSwitchToCostume: {
            type: 'command',
            category: 'looks',
            spec: 'switch to the costume or look of %cst'
        },
        doWearNextCostume: {
            type: 'command',
            category: 'looks',
            spec: 'wear the next costume or look %cst'
        },
        getCostumeIdx: {
            type: 'reporter',
            category: 'looks',
        ...
        doSayFor: {
            ...
            type: 'command',
            category: 'looks',
            spec: 'make the sprite have a speech bubble that says %s for %n seconds',
        ...
        bubble: {
            ...
            type: 'command',
            category: 'looks',
            spec: 'make the sprite have a speech bubble that says %s',
        ...
        doThinkFor: {
            ...
            type: 'command',
            category: 'looks',
            spec: 'make the sprite have a thought bubble that says %s for %n seconds',
        ...
        doThink: {
            ...
            type: 'command',
            category: 'looks',
            spec: 'make the sprite have a thought bubble that says %s',
        ...
        clearEffects: {
            type: 'command',
            category: 'looks',
            spec: 'clear all of the graphic effects for this sprite'
        },
        changeScale: {
            only: SpriteMorph,
            type: 'command',
            category: 'looks',
            spec: 'change the sprite size on the canvas by %n',
            defaults: [10]
        },
        setScale: {
            only: SpriteMorph,
            type: 'command',
            category: 'looks',
            spec: 'make the sprite size on the canvas to %n ',
            defaults: [100]
        },
        getScale: {
            only: SpriteMorph,
        ...
        show: {
            type: 'command',
            category: 'looks',
            spec: 'show sprite on the canvas'
        },
        hide: {
            type: 'command', 
            category: 'looks',
            spec: 'hide sprite on the canvas'
        },
        reportShown: {
            type: 'predicate',
            category: 'looks',
        ...
        goBack: {
            ...
            type: 'command',
            category: 'looks',
            spec: 'make sprite go back %n layers on the canvas',
            defaults: [1]
        },
        ...
        playSound: {
            type: 'command',
            category: 'sound',
            spec: 'play the sound or song %snd WITHOUT checking if it is completed'
        },
        doPlaySoundUntilDone: {
            type: 'command',
            category: 'sound',
            spec: 'play the sound or song %snd and wait until it is completed to play another one from this sprite'
        },
        doPlaySoundAtRate: {
            type: 'command',
            category: 'sound',
            spec: 'play the sound or song %snd at the Hz rate of %rate',
            defaults: ['', 44100]
        },
        doStopAllSounds: {
            type: 'command',
            category: 'sound',
            spec: 'stop all of the currently playing sounds on the canvas'
        },
        ...
        doRest: {
            type: 'command',
            category: 'sound',
            spec: 'rest notes for %n beats',
            defaults: [0.2]
        },
        doPlayNote: {
            type: 'command',
            category: 'sound',
            spec: 'play the note %note for the amount of beats being %n beats',
            defaults: [60, 0.5]
        },
        doPlayFrequency: { // only in dev mode - experimental
            type: 'command',
            category: 'sound',
            spec: 'play the frequency %n of Hz for %n seconds',
            defaults: [440, 2]
        },
        doSetInstrument: {
            type: 'command',
            category: 'sound',
            spec: 'set the musical instrument to %inst',
            defaults: [1]
        },
        doChangeTempo: {
            type: 'command',
            category: 'sound',
            spec: 'change the current tempo by %n beats per minute',
            defaults: [20]
        },
        doSetTempo: {
            type: 'command',
            category: 'sound',
            spec: 'set the tempo to %n beats per minute',
            defaults: [60]
        },
        getTempo: {
            type: 'reporter',
        ...
        changeVolume: {
            type: 'command',
            category: 'sound',
            spec: 'change the current volume by %n',
            defaults: [10]
        },
        setVolume: {
            type: 'command',
            category: 'sound',
            spec: 'set the volume to %n percent',
            defaults: [100]
        },
        getVolume: {
            type: 'reporter',
        ...
        changePan: {
            type: 'command',
            category: 'sound',
            spec: 'change the balance or pan or how much music is in one ear by %n',
            defaults: [10]
        },
        setPan: {
            type: 'command',
            category: 'sound',
            spec: 'set balance or pan or how much music is in one ear to %n',
            defaults: [0]
        },
        getPan: {
            type: 'reporter',
        ...
        playFreq: {
            type: 'command',
            category: 'sound',
            spec: 'play the frequency %n Hz',
            defaults: [440]
        },
        stopFreq: {
            type: 'command',
            category: 'sound',
            spec: 'stop the frequency'
        },
        ...
        clear: {
            type: 'command',
            category: 'pen',
            spec: 'clear all the things the pen has made on the canvas'
        },
        down: {
            only: SpriteMorph,
            type: 'command',
            category: 'pen',
            spec: 'make the pen start drawing stuff'
        },
        up: {
            only: SpriteMorph,
            type: 'command',
            category: 'pen',
            spec: 'make the pen stop drawing stuff'
        },
        getPenDown: {
            only: SpriteMorph,
            type: 'predicate',
            category: 'pen',
            spec: 'is the pen currently drawing things? i know, so click me to find out'
        },
        setColor: {
            only: SpriteMorph,
            type: 'command',
            category: 'pen',
            spec: 'set pen color to %clr so it will draw stuff on the canvas with that color'
        },
        ...
        changePenColorDimension: {
            ...
            type: 'command',
            category: 'pen',
            spec: 'change the pens %clrdim by %n',
            defaults: [['hue'], 10]
        },
        getPenAttribute: {
            type: 'reporter',
        ...
        setBackgroundColor: {
            ...
            type: 'command',
            category: 'pen',
            spec: 'set the canvas background color to %clr'
        },
        setBackgroundColorDimension: {
            only: StageMorph,
            type: 'command',
            category: 'pen',
            spec: 'set the canvas background %clrdim to %n',
            defaults: [['hue'], 50]
        },
        changeBackgroundColorDimension: {
            ...
            type: 'command',
            category: 'pen',
            spec: 'change the canvas background %clrdim by %n',
            defaults: [['hue'], 10]
        },
        changeSize: {
            only: SpriteMorph,
            type: 'command',
            category: 'pen',
            spec: 'change the pen size by %n sizes',
            defaults: [1]
        },
        setSize: {
            only: SpriteMorph,
        ...
        doStamp: {
            ...
            type: 'command',
            category: 'pen',
            spec: 'clone blocks long lost brother'
        },
        floodFill: {
            only: SpriteMorph,
            type: 'command',
        ...
        write: {
            ...
            type: 'command',
            category: 'pen',
            spec: 'force the pen into writing the words %s in the size size %n for our own entertainment',
            defaults: [localize('smh you guys are monsters! quit abusing the pen!'), 12]
        },
        ...
        receiveGo: {
            type: 'hat',
            category: 'control',
            spec: 'when green hat, %greenflag , _shout_go_ button, or the button with the green flag next to the pause button clicked?'
        },
        receiveKey: {
            type: 'hat',
            category: 'control',
            spec: 'when the %keyHat key on the keyboardpressed %keyName',
            defaults: [['shift']]
        },
        receiveInteraction: {
            type: 'hat',
        ...
        receiveMessage: {
            type: 'hat',
            category: 'control',
            spec: 'when I receive the message %msgHat %message run the follwing code',
            defaults: [''] // trigger the "message" expansion to refresh
        },
        receiveCondition: {
            type: 'hat',
            category: 'control',
            spec: 'when %b condition is true'
        },
        ...
        doBroadcast: {
            type: 'command',
            category: 'control',
            spec: 'broadcast the message %msg %receive'
        },
        doBroadcastAndWait: {
            type: 'command',
            category: 'control',
            spec: 'broadcast the messagev %msg %receive and wait the message is received'
        },
        doWait: {
            type: 'command',
            category: 'control',
            spec: 'wait %n seconds until continuing',
            defaults: [1]
        },
        doWaitUntil: {
            type: 'command',
            category: 'control',
            spec: 'wait until %b condition is true'
        },
        doForever: {
            type: 'command',
            category: 'control',
            spec: 'forever run the code inside the loop %loop'
        },
        doRepeat: {
            type: 'command',
            category: 'control',
        ...
        doUntil: {
            type: 'command',
            category: 'control',
            spec: 'repeat until %b condition is true run the code inside the loop %loop'
        },
        doFor: {
            type: 'command',
            category: 'control',
            spec: 'for %upvar = %n to %n %cla aka block that look scary when youre in snap! source code',
            defaults: ['i', 1, 10]
        },
        doIf: {
            type: 'command',
            category: 'control',
            spec: 'if %b condition is true run the code in the c-shape %c'
        },
        doIfElse: {
            type: 'command',
            category: 'control',
            spec: 'if %b condition is true run the code in the c-shape%c but if the condition is false run this code in the c-shape %c'
        },
        reportIfElse: {
            type: 'reporter',
            category: 'control',
        ...
        doRun: {
            type: 'command',
            category: 'control',
            spec: 'run the code in the ring %cmdRing %inputs'
        },
        fork: {
            type: 'command',
            category: 'control',
            spec: 'why is the launch block called fork in the source code %cmdRing %inputs'
        },
        evaluate: {
            type: 'reporter',
            category: 'control',
        ...
        doCallCC: {
            type: 'command',
            category: 'control',
            spec: 'run the code in the ring %cmdRing with continuation'
        },
        reportCallCC: {
            type: 'reporter',
            category: 'control',
        ...
        doTellTo: {
            ...
            spec: 'tell sprite %spr to do %cl %inputs'
        },
        reportAskFor: {
            type: 'reporter',
            category: 'control',
        ...
        receiveOnClone: {
            type: 'hat',
            category: 'control',
            spec: 'when I start as a clone run the following code'
        },
        createClone: {
            type: 'command',
            category: 'control',
        ...
        removeClone: {
            type: 'command',
            category: 'control',
            spec: 'delete this clone and now you cantrun any code after this lol'
        },
